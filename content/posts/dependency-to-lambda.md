...
<ul class="cv-list">
  ...
  <li id="ref-chen2014"><strong>Chen, D.</strong> and Christopher D. Manning. <a href="https://aclanthology.org/D14-1082/">"A fast and accurate dependency parser using neural networks."</a> <em>Proceedings of the 2014 Conference on Empirical Methods in Natural Language Processing (EMNLP)</em>, pp. 740–750. 2014.</li>
  ...
  <li id="ref-upshotmontague"><strong>Kim, Y.</strong> and Raymond Mooney. <a href="https://github.com/Workday/upshot-montague">upshot-montague</a>: A CCG-based semantic parsing library implementing Montague semantics in Scala. 2013.</li>
